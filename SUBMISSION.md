...
- **Model Endpoint Verification:** Implemented a ping loop to verify model availability before attempting the primary generation.
...
- **Interactive CLI Commands:**
  - `/reset`: Wipes the memory buffer to demonstrate context loss.
  - `/tokens`: Retrieves and prints the token usage.
